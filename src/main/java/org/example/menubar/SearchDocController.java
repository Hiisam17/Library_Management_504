...
public class SearchDocController { // Dùng cho user
  ...
  private void handleSearch() {
    ...
    ObservableList<Document> searchResults = FXCollections.observableArrayList(documentManager.searchDocument(keyword));
